    ...
    <div class='row'> <!-- footer -->
      <div class='col-12' id="footer">
        <footer class="blog-footer">
          ...
          <p style="padding:0px;font-size:small" class="text-center">Copyright © 2017-2020 Endeavour Explorer Scouts Unit (Wiltshire North), All rights reserved.
